...
async function testDatabaseConnection() {
    ...
    try {
        ...
        const dailyChallenges = await prisma_1.default.dailyChallenge.count();
        const weeklyChallenges = await prisma_1.default.weeklyChallenge.count();
        console.log(`🎯 Found ${dailyChallenges} daily challenges and ${weeklyChallenges} weekly challenges`);
